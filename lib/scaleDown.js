...
module.exports = data => {
    const instances = R.filter(isInstanceNearHour(data.ec2Instances), R.sortBy(instance => -R.countBy(az, data.containerInstances)[az(instance)], data.containerInstances));
